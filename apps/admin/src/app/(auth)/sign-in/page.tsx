...
import { admin_env as env } from "@/lib/env";
...
export default function LoginPage() {
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            toast.error("You are not the permitted User for this App");
        })();
    ...
    const handleLogin = async () => {
        await signIn.social({
            provider: "github",
            callbackURL: `${env.NEXT_PUBLIC_ADMIN_APP_URL}?success=true`,
            errorCallbackURL: `${env.NEXT_PUBLIC_ADMIN_APP_URL}/sign-in`,
        })
    };
