    ...
    return (
        <div className='min-h-auto w-160 flex flex-col justify-start items-center px-4 pt-2 pb-12'>
            ...
            <div className="w-full rounded-xl flex flex-col items-start gap-4 bg-white pb-6">
                <p className='font-apparel tracking-[0.3px] italic text-[#292929] section-heading-stroke-dark text-[26px]'>
                    Skill and Tools.
                </p>
            ...
            <div className="w-full flex flex-col gap-6">
                {([
                    ...
                    <div key={type} className="w-full flex flex-col gap-3">
                        <p className="font-sans font-medium tracking-[0.1px] text-neutral-500 text-[13px] uppercase px-1">
                            {label}
                        </p>
