...
const Introduction = () => {
    return (
        <div className='min-h-full w-full max-w-160 flex flex-col justify-start items-center'>
            ...
            <div className="w-full text-[12.5px] sm:text-[13.5px] px-4 py-2 flex flex-col items-start gap-[3px] text-gray-500 tracking-[0px] md:tracking-[0.1px]">
                <p>
            ...
            <div className='w-full text-[12.5px] sm:text-[13.5px] px-4 py-2 flex flex-col items-center gap-2'>
            ...
            <div className='w-full px-4 py-2 flex items-center gap-2'>
                <CalDotCom className='font-medium tracking-tight bg-[#3b3b3b] border-2 border-[#c3c3c3] px-2 h-8.5 flex items-center justify-center gap-5 rounded-full hover:bg-[#424242] drop-shadow-md drop-shadow-neutral-400'>
                    ...
                    <p className='text-[12.5px] sm:text-[13px]'>Book an Introductry Call</p>
